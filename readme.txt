...
This plugin allows admins to restrict access to portions of their websites. Visitors can sign up as users on the front-end of any page of your website using shortcodes, and signing up can either require a one-time paid membership, recurring monthly or annual membership payments or can be free.
