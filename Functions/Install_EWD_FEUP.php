...
function Install_EWD_FEUP() {
	...
	if (get_option("EWD_FEUP_Username_Is_Email") == "") {update_option("EWD_FEUP_Username_Is_Email", "Yes");}
	...
	if (get_option("EWD_FEUP_PayPal_Email_Address") == "") {update_option("EWD_FEUP_PayPal_Email_Address", "");}
